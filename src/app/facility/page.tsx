          ...
          <div className="mb-6 flex flex-col md:flex-row justify-between items-center gap-4 bg-slate-50 p-4 rounded-md border border-slate-200">
            ...
            <div className="relative w-full md:w-72">
              <input
                ...
                className="w-full pl-10 pr-4 py-2 text-sm text-slate-900 border border-slate-300 rounded-sm focus:outline-none focus:border-orange-600 focus:ring-1 focus:ring-orange-600 transition bg-white"
              />
