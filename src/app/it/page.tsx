      ...
      <div className="w-full max-w-7xl bg-white rounded-lg shadow-xl overflow-hidden border border-slate-300">
        ...
        <div className="bg-slate-800 text-white px-6 py-4 flex items-center justify-between select-none">
          ...
          <div className="flex gap-2">
            <button onClick={() => router.push('/')} className="text-xs bg-slate-700/50 hover:bg-slate-600 px-4 py-2 rounded transition font-bold border border-white/20">HOME</button>
            <button onClick={() => window.location.reload()} className="text-xs bg-slate-700/50 hover:bg-emerald-500 px-4 py-2 rounded transition font-bold border border-white/20 shadow-md flex items-center gap-1">🔄새로고침</button>
          ...
          <div className="mb-6 flex flex-col md:flex-row justify-between items-center gap-4 bg-slate-50 p-4 rounded-lg border border-slate-200">
            ...
            <div className="relative w-full md:w-72">
              <input
                ...
                className="w-full pl-10 pr-4 py-2 text-sm text-slate-900 border border-slate-300 rounded-md focus:outline-none focus:border-slate-800 focus:ring-1 focus:ring-slate-800 transition bg-white"
              />
