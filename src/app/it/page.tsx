      ...
      <div className="w-full max-w-7xl bg-white rounded-lg shadow-xl overflow-hidden border border-slate-300">
        ...
        <div className="bg-slate-800 text-white px-6 py-4 flex items-center justify-between select-none">
          ...
          <div className="flex gap-2">
            <button onClick={() => router.push('/')} className="text-sm bg-slate-700 hover:bg-slate-600 px-4 py-2 rounded transition font-bold border border-slate-600">HOME</button>
            <button onClick={() => router.push('/write?type=it')} className="text-sm bg-blue-600 hover:bg-blue-500 px-4 py-2 rounded transition font-bold shadow-md">+ 글작성</button>
          </div>
        </div>
